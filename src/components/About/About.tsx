...
import profileImage from "../../assets/asimProfile.jpg";
    ...
    <Container id="sobre">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.2 * 1000}>
          <p>I'm Asim from Mianwali. I have passed the Matric Examination from Govt.Gillani School Wah-cantt and passed the FSC Examination from Fazaia college Mianwali. Currently, I'm studying Software Engineering from Air University Islamabad. Along with , I work as a React Engineer at BCDapps.</p>
        </ScrollAnimation>
